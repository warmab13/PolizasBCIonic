...
.run(function($ionicPlatform) {
  ...
  .run(function ChangeStateError($rootScope) {
...
.config(function($stateProvider, $urlRouterProvider) {
  ...
  .state('login',{
    ...
    onEnter: ['$state','UserService',function ($state, UserService) {
        if(UserService.isLogged() && $state.transition){
          /*
            Bug states in ui-router resolve
  ...
  .state('tab.purchases', {
    ...
    resolve: {
      ...
      recentPurchases:['PurchaseService',function(PurchaseService){
        return PurchaseService.getRecentPurchases();
      }]
    }
  })
